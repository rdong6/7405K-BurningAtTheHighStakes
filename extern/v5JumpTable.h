...
inline uint32_t fnVexSystemVersion() { return *(uint32_t *)(0x037FD000); }
inline uint32_t fnVexosVersion() { return *(uint32_t *)(0x037fd008); }
inline uint32_t fnStdlibVersion() { return *(uint32_t *)(0x037fd004); }
inline uint32_t fnCpu0Version() { return *(uint32_t *)(0x037fd00c); }
...
typedef enum {
  ...
  kMotorControlModeVELOCITY =
      5, /// Motor is unlimited movement at set 'velocity'
...
#define V5_COMP_BIT_COMP                                                       \
  4 // if set then either comp switch or field control connected
#define V5_COMP_BIT_GAME 8 // if set then field control connected
#define V5_COMP_BIT_OPT1                                                       \
  16 // if set then option1 bit is set (vexos 1.1.3 and later)
#define V5_COMP_BIT_OPT2                                                       \
  32 // if set then option2 bit is set (vexos 1.1.3 and later)
...
inline t_vexScratchMemoryLock fnVexScratchMemoryLock =
    (t_vexScratchMemoryLock)(*(uint32_t *)0x37fc998);

typedef void (*t_vexScratchMemoryUnlock)(void);
inline t_vexScratchMemoryUnlock fnVexScratchMemoryUnlock =
    (t_vexScratchMemoryUnlock)(*(uint32_t *)0x37fc99c);

typedef uint32_t (*t_vexDevicesGetNumber)(void);
inline t_vexDevicesGetNumber fnVexDevicesGetNumber =
    (t_vexDevicesGetNumber)(*(uint32_t *)0x37fc190);

typedef uint32_t (*t_vexDevicesGetNumberByType)(V5_DeviceType type);
inline t_vexDevicesGetNumberByType fnVexDevicesGetNumberByType =
    (t_vexDevicesGetNumberByType)(*(uint32_t *)0x37fc194);

typedef V5_DeviceT (*t_vexDevicesGet)(void);
inline t_vexDevicesGet fnVexDevicesGet =
    (t_vexDevicesGet)(*(uint32_t *)0x37fc198);

typedef V5_DeviceT (*t_vexDeviceGetByIndex)(uint32_t index);
inline t_vexDeviceGetByIndex fnVexDeviceGetByIndex =
    (t_vexDeviceGetByIndex)(*(uint32_t *)0x37fc19c);

typedef int32_t (*t_vexDeviceGetStatus)(V5_DeviceType *buffer);
inline t_vexDeviceGetStatus fnVexDeviceGetStatus =
    (t_vexDeviceGetStatus)(*(uint32_t *)0x37fc1a0);

typedef int32_t (*t_vexDeviceGetTimestamp)(V5_DeviceT device);
inline t_vexDeviceGetTimestamp fnVexDeviceGetTimestamp =
    (t_vexDeviceGetTimestamp)(*(uint32_t *)0x37fc1b0);

typedef uint32_t (*t_vexDeviceButtonStateGet)(void);
inline t_vexDeviceButtonStateGet fnVexDeviceButtonStateGet =
    (t_vexDeviceButtonStateGet)(*(uint32_t *)0x37fc1b4);

typedef int32_t (*t_vexControllerGet)(V5_ControllerId id,
                                      V5_ControllerIndex index);
inline t_vexControllerGet fnVexControllerGet =
    (t_vexControllerGet)(*(uint32_t *)0x37fc1a4);

typedef V5_ControllerStatus (*t_vexControllerConnectionStatusGet)(
    V5_ControllerId id);
...
typedef bool (*t_vexControllerTextSet)(V5_ControllerId id, uint32_t line,
                                       uint32_t col, const char *str);
inline t_vexControllerTextSet fnVexControllerTextSet =
    (t_vexControllerTextSet)(*(uint32_t *)0x37fc1ac);

typedef void (*t_vexDeviceLedSet)(V5_DeviceT device, V5_DeviceLedColor value);
inline t_vexDeviceLedSet fnVexDeviceLedSet =
    (t_vexDeviceLedSet)(*(uint32_t *)0x37fc1e0);

typedef void (*t_vexDeviceLedRgbSet)(V5_DeviceT device, uint32_t color);
inline t_vexDeviceLedRgbSet fnVexDeviceLedRgbSet =
    (t_vexDeviceLedRgbSet)(*(uint32_t *)0x37fc1e4);

typedef V5_DeviceLedColor (*t_vexDeviceLedGet)(V5_DeviceT device);
inline t_vexDeviceLedGet fnVexDeviceLedGet =
    (t_vexDeviceLedGet)(*(uint32_t *)0x37fc1e8);

typedef uint32_t (*t_vexDeviceLedRgbGet)(V5_DeviceT device);
inline t_vexDeviceLedRgbGet fnVexDeviceLedRgbGet =
    (t_vexDeviceLedRgbGet)(*(uint32_t *)0x37fc1ec);

typedef void (*t_vexDeviceAdiPortConfigSet)(V5_DeviceT device, uint32_t port,
                                            V5_AdiPortConfiguration type);
inline t_vexDeviceAdiPortConfigSet fnVexDeviceAdiPortConfigSet =
    (t_vexDeviceAdiPortConfigSet)(*(uint32_t *)0x37fc208);

typedef V5_AdiPortConfiguration (*t_vexDeviceAdiPortConfigGet)(
    V5_DeviceT device, uint32_t port);
inline t_vexDeviceAdiPortConfigGet fnVexDeviceAdiPortConfigGet =
    (t_vexDeviceAdiPortConfigGet)(*(uint32_t *)0x37fc20c);

typedef void (*t_vexDeviceAdiValueSet)(V5_DeviceT device, uint32_t port,
                                       int32_t value);
inline t_vexDeviceAdiValueSet fnVexDeviceAdiValueSet =
    (t_vexDeviceAdiValueSet)(*(uint32_t *)0x37fc210);

typedef int32_t (*t_vexDeviceAdiValueGet)(V5_DeviceT device, uint32_t port);
inline t_vexDeviceAdiValueGet fnVexDeviceAdiValueGet =
    (t_vexDeviceAdiValueGet)(*(uint32_t *)0x37fc214);

typedef V5_DeviceBumperState (*t_vexDeviceBumperGet)(V5_DeviceT device);
inline t_vexDeviceBumperGet fnVexDeviceBumperGet =
    (t_vexDeviceBumperGet)(*(uint32_t *)0x37fc230);

typedef void (*t_vexDeviceGyroReset)(V5_DeviceT device);
inline t_vexDeviceGyroReset fnVexDeviceGyroReset =
    (t_vexDeviceGyroReset)(*(uint32_t *)0x37fc258);

typedef double (*t_vexDeviceGyroHeadingGet)(V5_DeviceT device);
inline t_vexDeviceGyroHeadingGet fnVexDeviceGyroHeadingGet =
    (t_vexDeviceGyroHeadingGet)(*(uint32_t *)0x37fc25c);

typedef double (*t_vexDeviceGyroDegreesGet)(V5_DeviceT device);
inline t_vexDeviceGyroDegreesGet fnVexDeviceGyroDegreesGet =
    (t_vexDeviceGyroDegreesGet)(*(uint32_t *)0x37fc260);

typedef int32_t (*t_vexDeviceSonarValueGet)(V5_DeviceT device);
inline t_vexDeviceSonarValueGet fnVexDeviceSonarValueGet =
    (t_vexDeviceSonarValueGet)(*(uint32_t *)0x37fc280);

typedef int32_t (*t_vexDeviceGenericValueGet)(V5_DeviceT device);
inline t_vexDeviceGenericValueGet fnVexDeviceGenericValueGet =
    (t_vexDeviceGenericValueGet)(*(uint32_t *)0x37fc2a8);

typedef void (*t_vexDeviceMotorVelocitySet)(V5_DeviceT device,
                                            int32_t velocity);
inline t_vexDeviceMotorVelocitySet fnVexDeviceMotorVelocitySet =
    (t_vexDeviceMotorVelocitySet)(*(uint32_t *)0x37fc2d0);

typedef void (*t_vexDeviceMotorVelocityUpdate)(V5_DeviceT device,
                                               int32_t velocity);
...
inline t_vexDeviceMotorModeSet fnVexDeviceMotorModeSet =
    (t_vexDeviceMotorModeSet)(*(uint32_t *)0x37fc2e0);

typedef V5MotorControlMode (*t_vexDeviceMotorModeGet)(V5_DeviceT device);
inline t_vexDeviceMotorModeGet fnVexDeviceMotorModeGet =
    (t_vexDeviceMotorModeGet)(*(uint32_t *)0x37fc2e4);

typedef void (*t_vexDeviceMotorPwmSet)(V5_DeviceT device, int32_t value);
inline t_vexDeviceMotorPwmSet fnVexDeviceMotorPwmSet =
    (t_vexDeviceMotorPwmSet)(*(uint32_t *)0x37fc2e8);

typedef int32_t (*t_vexDeviceMotorPwmGet)(V5_DeviceT device);
inline t_vexDeviceMotorPwmGet fnVexDeviceMotorPwmGet =
    (t_vexDeviceMotorPwmGet)(*(uint32_t *)0x37fc2ec);

typedef void (*t_vexDeviceMotorCurrentLimitSet)(V5_DeviceT device,
                                                int32_t value);
...
typedef void (*t_vexDeviceMotorVoltageLimitSet)(V5_DeviceT device,
                                                int32_t value);
...
typedef void (*t_vexDeviceMotorPositionPidSet)(V5_DeviceT device,
                                               V5_DeviceMotorPid *pid);
inline t_vexDeviceMotorPositionPidSet fnVexDeviceMotorPositionPidSet =
    (t_vexDeviceMotorPositionPidSet)(*(uint32_t *)0x37fc378);

typedef void (*t_vexDeviceMotorVelocityPidSet)(V5_DeviceT device,
                                               V5_DeviceMotorPid *pid);
...
inline t_vexDeviceMotorCurrentGet fnVexDeviceMotorCurrentGet =
    (t_vexDeviceMotorCurrentGet)(*(uint32_t *)0x37fc2f8);

typedef int32_t (*t_vexDeviceMotorVoltageGet)(V5_DeviceT device);
inline t_vexDeviceMotorVoltageGet fnVexDeviceMotorVoltageGet =
    (t_vexDeviceMotorVoltageGet)(*(uint32_t *)0x37fc360);

typedef double (*t_vexDeviceMotorPowerGet)(V5_DeviceT device);
inline t_vexDeviceMotorPowerGet fnVexDeviceMotorPowerGet =
    (t_vexDeviceMotorPowerGet)(*(uint32_t *)0x37fc2fc);

typedef double (*t_vexDeviceMotorTorqueGet)(V5_DeviceT device);
inline t_vexDeviceMotorTorqueGet fnVexDeviceMotorTorqueGet =
    (t_vexDeviceMotorTorqueGet)(*(uint32_t *)0x37fc300);

typedef double (*t_vexDeviceMotorEfficiencyGet)(V5_DeviceT device);
inline t_vexDeviceMotorEfficiencyGet fnVexDeviceMotorEfficiencyGet =
    (t_vexDeviceMotorEfficiencyGet)(*(uint32_t *)0x37fc304);
...
inline t_vexDeviceMotorFaultsGet fnVexDeviceMotorFaultsGet =
    (t_vexDeviceMotorFaultsGet)(*(uint32_t *)0x37fc354);
...
inline t_vexDeviceMotorFlagsGet fnVexDeviceMotorFlagsGet =
    (t_vexDeviceMotorFlagsGet)(*(uint32_t *)0x37fc358);
...
typedef void (*t_vexDeviceMotorEncoderUnitsSet)(V5_DeviceT device,
                                                V5MotorEncoderUnits units);
inline t_vexDeviceMotorEncoderUnitsSet fnVexDeviceMotorEncoderUnitsSet =
    (t_vexDeviceMotorEncoderUnitsSet)(*(uint32_t *)0x37fc324);

typedef V5MotorEncoderUnits (*t_vexDeviceMotorEncoderUnitsGet)(
    V5_DeviceT device);
inline t_vexDeviceMotorEncoderUnitsGet fnVexDeviceMotorEncoderUnitsGet =
    (t_vexDeviceMotorEncoderUnitsGet)(*(uint32_t *)0x37fc328);

typedef void (*t_vexDeviceMotorBrakeModeSet)(V5_DeviceT device,
                                             V5MotorBrakeMode mode);
inline t_vexDeviceMotorBrakeModeSet fnVexDeviceMotorBrakeModeSet =
    (t_vexDeviceMotorBrakeModeSet)(*(uint32_t *)0x37fc32c);

typedef V5MotorBrakeMode (*t_vexDeviceMotorBrakeModeGet)(V5_DeviceT device);
inline t_vexDeviceMotorBrakeModeGet fnVexDeviceMotorBrakeModeGet =
    (t_vexDeviceMotorBrakeModeGet)(*(uint32_t *)0x37fc330);

typedef void (*t_vexDeviceMotorPositionSet)(V5_DeviceT device, double position);
inline t_vexDeviceMotorPositionSet fnVexDeviceMotorPositionSet =
    (t_vexDeviceMotorPositionSet)(*(uint32_t *)0x37fc334);

typedef double (*t_vexDeviceMotorPositionGet)(V5_DeviceT device);
inline t_vexDeviceMotorPositionGet fnVexDeviceMotorPositionGet =
    (t_vexDeviceMotorPositionGet)(*(uint32_t *)0x37fc338);

typedef int32_t (*t_vexDeviceMotorPositionRawGet)(V5_DeviceT device,
                                                  uint32_t *timestamp);
...
inline t_vexDeviceMotorPositionReset fnVexDeviceMotorPositionReset =
    (t_vexDeviceMotorPositionReset)(*(uint32_t *)0x37fc340);

typedef double (*t_vexDeviceMotorTargetGet)(V5_DeviceT device);
inline t_vexDeviceMotorTargetGet fnVexDeviceMotorTargetGet =
    (t_vexDeviceMotorTargetGet)(*(uint32_t *)0x37fc344);

typedef void (*t_vexDeviceMotorServoTargetSet)(V5_DeviceT device,
                                               double position);
inline t_vexDeviceMotorServoTargetSet fnVexDeviceMotorServoTargetSet =
    (t_vexDeviceMotorServoTargetSet)(*(uint32_t *)0x37fc348);

typedef void (*t_vexDeviceMotorAbsoluteTargetSet)(V5_DeviceT device,
                                                  double position,
                                                  int32_t velocity);
...
typedef void (*t_vexDeviceMotorRelativeTargetSet)(V5_DeviceT device,
                                                  double position,
                                                  int32_t velocity);
...
typedef void (*t_vexDeviceMotorGearingSet)(V5_DeviceT device,
                                           V5MotorGearset value);
inline t_vexDeviceMotorGearingSet fnVexDeviceMotorGearingSet =
    (t_vexDeviceMotorGearingSet)(*(uint32_t *)0x37fc364);

typedef V5MotorGearset (*t_vexDeviceMotorGearingGet)(V5_DeviceT device);
inline t_vexDeviceMotorGearingGet fnVexDeviceMotorGearingGet =
    (t_vexDeviceMotorGearingGet)(*(uint32_t *)0x37fc368);

typedef void (*t_vexDeviceMotorExternalProfileSet)(V5_DeviceT device,
                                                   double position,
                                                   int32_t velocity);
...
inline t_vexDeviceMotorTypeGet fnVexDeviceMotorTypeGet =
    (t_vexDeviceMotorTypeGet)(*(uint32_t *)0x37fc384);

typedef void (*t_vexDeviceVisionModeSet)(V5_DeviceT device, V5VisionMode mode);
inline t_vexDeviceVisionModeSet fnVexDeviceVisionModeSet =
    (t_vexDeviceVisionModeSet)(*(uint32_t *)0x37fc398);

typedef V5VisionMode (*t_vexDeviceVisionModeGet)(V5_DeviceT device);
inline t_vexDeviceVisionModeGet fnVexDeviceVisionModeGet =
    (t_vexDeviceVisionModeGet)(*(uint32_t *)0x37fc39c);
...
typedef int32_t (*t_vexDeviceVisionObjectGet)(V5_DeviceT device,
                                              uint32_t indexObj,
                                              V5_DeviceVisionObject *pObject);
inline t_vexDeviceVisionObjectGet fnVexDeviceVisionObjectGet =
    (t_vexDeviceVisionObjectGet)(*(uint32_t *)0x37fc3a4);

typedef void (*t_vexDeviceVisionSignatureSet)(
    V5_DeviceT device, V5_DeviceVisionSignature *pSignature);
inline t_vexDeviceVisionSignatureSet fnVexDeviceVisionSignatureSet =
    (t_vexDeviceVisionSignatureSet)(*(uint32_t *)0x37fc3a8);

typedef bool (*t_vexDeviceVisionSignatureGet)(
    V5_DeviceT device, uint32_t id, V5_DeviceVisionSignature *pSignature);
inline t_vexDeviceVisionSignatureGet fnVexDeviceVisionSignatureGet =
    (t_vexDeviceVisionSignatureGet)(*(uint32_t *)0x37fc3ac);

typedef void (*t_vexDeviceVisionBrightnessSet)(V5_DeviceT device,
                                               uint8_t percent);
...
typedef void (*t_vexDeviceVisionWhiteBalanceModeSet)(V5_DeviceT device,
                                                     V5VisionWBMode mode);
inline t_vexDeviceVisionWhiteBalanceModeSet
    fnVexDeviceVisionWhiteBalanceModeSet =
        (t_vexDeviceVisionWhiteBalanceModeSet)(*(uint32_t *)0x37fc3b8);

typedef V5VisionWBMode (*t_vexDeviceVisionWhiteBalanceModeGet)(
    V5_DeviceT device);
inline t_vexDeviceVisionWhiteBalanceModeGet
    fnVexDeviceVisionWhiteBalanceModeGet =
        (t_vexDeviceVisionWhiteBalanceModeGet)(*(uint32_t *)0x37fc3bc);

typedef void (*t_vexDeviceVisionWhiteBalanceSet)(V5_DeviceT device,
                                                 V5_DeviceVisionRgb color);
...
typedef V5_DeviceVisionRgb (*t_vexDeviceVisionWhiteBalanceGet)(
    V5_DeviceT device);
...
typedef void (*t_vexDeviceVisionLedModeSet)(V5_DeviceT device,
                                            V5VisionLedMode mode);
inline t_vexDeviceVisionLedModeSet fnVexDeviceVisionLedModeSet =
    (t_vexDeviceVisionLedModeSet)(*(uint32_t *)0x37fc3c8);

typedef V5VisionLedMode (*t_vexDeviceVisionLedModeGet)(V5_DeviceT device);
inline t_vexDeviceVisionLedModeGet fnVexDeviceVisionLedModeGet =
    (t_vexDeviceVisionLedModeGet)(*(uint32_t *)0x37fc3cc);

typedef void (*t_vexDeviceVisionLedBrigntnessSet)(V5_DeviceT device,
                                                  uint8_t percent);
...
typedef void (*t_vexDeviceVisionLedColorSet)(V5_DeviceT device,
                                             V5_DeviceVisionRgb color);
inline t_vexDeviceVisionLedColorSet fnVexDeviceVisionLedColorSet =
    (t_vexDeviceVisionLedColorSet)(*(uint32_t *)0x37fc3d8);

typedef V5_DeviceVisionRgb (*t_vexDeviceVisionLedColorGet)(V5_DeviceT device);
inline t_vexDeviceVisionLedColorGet fnVexDeviceVisionLedColorGet =
    (t_vexDeviceVisionLedColorGet)(*(uint32_t *)0x37fc3dc);

typedef void (*t_vexDeviceVisionWifiModeSet)(V5_DeviceT device,
                                             V5VisionWifiMode mode);
inline t_vexDeviceVisionWifiModeSet fnVexDeviceVisionWifiModeSet =
    (t_vexDeviceVisionWifiModeSet)(*(uint32_t *)0x37fc3e0);

typedef V5VisionWifiMode (*t_vexDeviceVisionWifiModeGet)(V5_DeviceT device);
inline t_vexDeviceVisionWifiModeGet fnVexDeviceVisionWifiModeGet =
    (t_vexDeviceVisionWifiModeGet)(*(uint32_t *)0x37fc3e4);

typedef void (*t_vexDeviceImuReset)(V5_DeviceT device);
inline t_vexDeviceImuReset fnVexDeviceImuReset =
    (t_vexDeviceImuReset)(*(uint32_t *)0x37fc410);

typedef double (*t_vexDeviceImuHeadingGet)(V5_DeviceT device);
inline t_vexDeviceImuHeadingGet fnVexDeviceImuHeadingGet =
    (t_vexDeviceImuHeadingGet)(*(uint32_t *)0x37fc414);

typedef double (*t_vexDeviceImuDegreesGet)(V5_DeviceT device);
inline t_vexDeviceImuDegreesGet fnVexDeviceImuDegreesGet =
    (t_vexDeviceImuDegreesGet)(*(uint32_t *)0x37fc418);

typedef void (*t_vexDeviceImuQuaternionGet)(V5_DeviceT device,
                                            V5_DeviceImuQuaternion *data);
inline t_vexDeviceImuQuaternionGet fnVexDeviceImuQuaternionGet =
    (t_vexDeviceImuQuaternionGet)(*(uint32_t *)0x37fc41c);

typedef void (*t_vexDeviceImuAttitudeGet)(V5_DeviceT device,
                                          V5_DeviceImuAttitude *data);
inline t_vexDeviceImuAttitudeGet fnVexDeviceImuAttitudeGet =
    (t_vexDeviceImuAttitudeGet)(*(uint32_t *)0x37fc420);

typedef void (*t_vexDeviceImuRawGyroGet)(V5_DeviceT device,
                                         V5_DeviceImuRaw *data);
inline t_vexDeviceImuRawGyroGet fnVexDeviceImuRawGyroGet =
    (t_vexDeviceImuRawGyroGet)(*(uint32_t *)0x37fc424);

typedef void (*t_vexDeviceImuRawAccelGet)(V5_DeviceT device,
                                          V5_DeviceImuRaw *data);
inline t_vexDeviceImuRawAccelGet fnVexDeviceImuRawAccelGet =
    (t_vexDeviceImuRawAccelGet)(*(uint32_t *)0x37fc428);

typedef uint32_t (*t_vexDeviceImuStatusGet)(V5_DeviceT device);
inline t_vexDeviceImuStatusGet fnVexDeviceImuStatusGet =
    (t_vexDeviceImuStatusGet)(*(uint32_t *)0x37fc42c);

typedef void (*t_vexDeviceImuModeSet)(V5_DeviceT device, uint32_t mode);
inline t_vexDeviceImuModeSet fnVexDeviceImuModeSet =
    (t_vexDeviceImuModeSet)(*(uint32_t *)0x37fc438);

typedef uint32_t (*t_vexDeviceImuModeGet)(V5_DeviceT device);
inline t_vexDeviceImuModeGet fnVexDeviceImuModeGet =
    (t_vexDeviceImuModeGet)(*(uint32_t *)0x37fc43c);

typedef void (*t_vexDeviceImuDataRateSet)(V5_DeviceT device, uint32_t rate);
inline t_vexDeviceImuDataRateSet fnVexDeviceImuDataRateSet =
    (t_vexDeviceImuDataRateSet)(*(uint32_t *)0x37fc444);

typedef int32_t (*t_vexDeviceRangeValueGet)(V5_DeviceT device);
inline t_vexDeviceRangeValueGet fnVexDeviceRangeValueGet =
    (t_vexDeviceRangeValueGet)(*(uint32_t *)0x37fc4d8);

typedef void (*t_vexDeviceAbsEncReset)(V5_DeviceT device);
inline t_vexDeviceAbsEncReset fnVexDeviceAbsEncReset =
    (t_vexDeviceAbsEncReset)(*(uint32_t *)0x37fc488);

typedef void (*t_vexDeviceAbsEncPositionSet)(V5_DeviceT device,
                                             int32_t position);
inline t_vexDeviceAbsEncPositionSet fnVexDeviceAbsEncPositionSet =
    (t_vexDeviceAbsEncPositionSet)(*(uint32_t *)0x37fc48c);

typedef int32_t (*t_vexDeviceAbsEncPositionGet)(V5_DeviceT device);
inline t_vexDeviceAbsEncPositionGet fnVexDeviceAbsEncPositionGet =
    (t_vexDeviceAbsEncPositionGet)(*(uint32_t *)0x37fc490);

typedef int32_t (*t_vexDeviceAbsEncVelocityGet)(V5_DeviceT device);
inline t_vexDeviceAbsEncVelocityGet fnVexDeviceAbsEncVelocityGet =
    (t_vexDeviceAbsEncVelocityGet)(*(uint32_t *)0x37fc494);

typedef int32_t (*t_vexDeviceAbsEncAngleGet)(V5_DeviceT device);
inline t_vexDeviceAbsEncAngleGet fnVexDeviceAbsEncAngleGet =
    (t_vexDeviceAbsEncAngleGet)(*(uint32_t *)0x37fc498);
...
inline t_vexDeviceAbsEncStatusGet fnVexDeviceAbsEncStatusGet =
    (t_vexDeviceAbsEncStatusGet)(*(uint32_t *)0x37fc4a4);

typedef void (*t_vexDeviceAbsEncDataRateSet)(V5_DeviceT device, uint32_t rate);
inline t_vexDeviceAbsEncDataRateSet fnVexDeviceAbsEncDataRateSet =
    (t_vexDeviceAbsEncDataRateSet)(*(uint32_t *)0x37fc4c0);

typedef double (*t_vexDeviceOpticalHueGet)(V5_DeviceT device);
inline t_vexDeviceOpticalHueGet fnVexDeviceOpticalHueGet =
    (t_vexDeviceOpticalHueGet)(*(uint32_t *)0x37fc528);

typedef double (*t_vexDeviceOpticalSatGet)(V5_DeviceT device);
inline t_vexDeviceOpticalSatGet fnVexDeviceOpticalSatGet =
    (t_vexDeviceOpticalSatGet)(*(uint32_t *)0x37fc52c);
...
typedef void (*t_vexDeviceOpticalRgbGet)(V5_DeviceT device,
                                         V5_DeviceOpticalRgb *data);
inline t_vexDeviceOpticalRgbGet fnVexDeviceOpticalRgbGet =
    (t_vexDeviceOpticalRgbGet)(*(uint32_t *)0x37fc538);

typedef void (*t_vexDeviceOpticalLedPwmSet)(V5_DeviceT device, int32_t value);
inline t_vexDeviceOpticalLedPwmSet fnVexDeviceOpticalLedPwmSet =
    (t_vexDeviceOpticalLedPwmSet)(*(uint32_t *)0x37fc53c);

typedef int32_t (*t_vexDeviceOpticalLedPwmGet)(V5_DeviceT device);
inline t_vexDeviceOpticalLedPwmGet fnVexDeviceOpticalLedPwmGet =
    (t_vexDeviceOpticalLedPwmGet)(*(uint32_t *)0x37fc540);

typedef uint32_t (*t_vexDeviceOpticalStatusGet)(V5_DeviceT device);
inline t_vexDeviceOpticalStatusGet fnVexDeviceOpticalStatusGet =
    (t_vexDeviceOpticalStatusGet)(*(uint32_t *)0x37fc544);

typedef void (*t_vexDeviceOpticalRawGet)(V5_DeviceT device,
                                         V5_DeviceOpticalRaw *data);
inline t_vexDeviceOpticalRawGet fnVexDeviceOpticalRawGet =
    (t_vexDeviceOpticalRawGet)(*(uint32_t *)0x37fc548);

typedef void (*t_vexDeviceOpticalModeSet)(V5_DeviceT device, uint32_t mode);
inline t_vexDeviceOpticalModeSet fnVexDeviceOpticalModeSet =
    (t_vexDeviceOpticalModeSet)(*(uint32_t *)0x37fc550);

typedef uint32_t (*t_vexDeviceOpticalModeGet)(V5_DeviceT device);
inline t_vexDeviceOpticalModeGet fnVexDeviceOpticalModeGet =
    (t_vexDeviceOpticalModeGet)(*(uint32_t *)0x37fc554);

typedef uint32_t (*t_vexDeviceOpticalGestureGet)(
    V5_DeviceT, V5_DeviceOpticalGesture *pData);
inline t_vexDeviceOpticalGestureGet fnVexDeviceOpticalGestureGet =
    (t_vexDeviceOpticalGestureGet)(*(uint32_t *)0x37fc558);
...
typedef int32_t (*t_vexDeviceOpticalProximityThreshold)(V5_DeviceT device,
                                                        int32_t value);
inline t_vexDeviceOpticalProximityThreshold
    fnVexDeviceOpticalProximityThreshold =
        (t_vexDeviceOpticalProximityThreshold)(*(uint32_t *)0x37fc564);

typedef void (*t_vexDeviceOpticalIntegrationTimeSet)(V5_DeviceT device,
                                                     double timeMs);
inline t_vexDeviceOpticalIntegrationTimeSet
    fnVexDeviceOpticalIntegrationTimeSet =
...
inline t_vexDeviceOpticalIntegrationTimeGet
    fnVexDeviceOpticalIntegrationTimeGet =
        (t_vexDeviceOpticalIntegrationTimeGet)(*(uint32_t *)0x37fcb44);

typedef void (*t_vexDeviceMagnetPowerSet)(V5_DeviceT device, int32_t value,
                                          int32_t time);
inline t_vexDeviceMagnetPowerSet fnVexDeviceMagnetPowerSet =
    (t_vexDeviceMagnetPowerSet)(*(uint32_t *)0x37fc578);

typedef int32_t (*t_vexDeviceMagnetPowerGet)(V5_DeviceT device);
inline t_vexDeviceMagnetPowerGet fnVexDeviceMagnetPowerGet =
    (t_vexDeviceMagnetPowerGet)(*(uint32_t *)0x37fc57c);

typedef void (*t_vexDeviceMagnetPickup)(V5_DeviceT device,
                                        V5_DeviceMagnetDuration duration);
inline t_vexDeviceMagnetPickup fnVexDeviceMagnetPickup =
    (t_vexDeviceMagnetPickup)(*(uint32_t *)0x37fc580);

typedef void (*t_vexDeviceMagnetDrop)(V5_DeviceT device,
                                      V5_DeviceMagnetDuration duration);
inline t_vexDeviceMagnetDrop fnVexDeviceMagnetDrop =
    (t_vexDeviceMagnetDrop)(*(uint32_t *)0x37fc584);
...
inline t_vexDeviceMagnetCurrentGet fnVexDeviceMagnetCurrentGet =
    (t_vexDeviceMagnetCurrentGet)(*(uint32_t *)0x37fc58c);

typedef uint32_t (*t_vexDeviceMagnetStatusGet)(V5_DeviceT device);
inline t_vexDeviceMagnetStatusGet fnVexDeviceMagnetStatusGet =
    (t_vexDeviceMagnetStatusGet)(*(uint32_t *)0x37fc590);

typedef void (*t_vexDeviceLightTowerRgbSet)(V5_DeviceT device,
                                            uint32_t rgb_value,
                                            uint32_t xyw_value);
inline t_vexDeviceLightTowerRgbSet fnVexDeviceLightTowerRgbSet =
    (t_vexDeviceLightTowerRgbSet)(*(uint32_t *)0x37fc5a0);

typedef void (*t_vexDeviceLightTowerColorSet)(V5_DeviceT device,
                                              uint32_t color_id,
                                              uint32_t value);
inline t_vexDeviceLightTowerColorSet fnVexDeviceLightTowerColorSet =
    (t_vexDeviceLightTowerColorSet)(*(uint32_t *)0x37fc5a4);

typedef uint32_t (*t_vexDeviceLightTowerRgbGet)(V5_DeviceT device);
inline t_vexDeviceLightTowerRgbGet fnVexDeviceLightTowerRgbGet =
    (t_vexDeviceLightTowerRgbGet)(*(uint32_t *)0x37fc5a8);

typedef uint32_t (*t_vexDeviceLightTowerXywGet)(V5_DeviceT device);
inline t_vexDeviceLightTowerXywGet fnVexDeviceLightTowerXywGet =
    (t_vexDeviceLightTowerXywGet)(*(uint32_t *)0x37fc5ac);
...
typedef void (*t_vexDeviceLightTowerBlinkSet)(V5_DeviceT device, uint8_t select,
                                              uint8_t mask, int32_t onTime,
                                              int32_t offTime);
inline t_vexDeviceLightTowerBlinkSet fnVexDeviceLightTowerBlinkSet =
    (t_vexDeviceLightTowerBlinkSet)(*(uint32_t *)0x37fc5b8);
...
inline t_vexDeviceDistanceObjectVelocityGet
    fnVexDeviceDistanceObjectVelocityGet =
        (t_vexDeviceDistanceObjectVelocityGet)(*(uint32_t *)0x37fc51c);

typedef uint32_t (*t_vexDeviceDistanceStatusGet)(V5_DeviceT device);
inline t_vexDeviceDistanceStatusGet fnVexDeviceDistanceStatusGet =
    (t_vexDeviceDistanceStatusGet)(*(uint32_t *)0x37fc508);

typedef void (*t_vexDeviceGpsReset)(V5_DeviceT device);
inline t_vexDeviceGpsReset fnVexDeviceGpsReset =
    (t_vexDeviceGpsReset)(*(uint32_t *)0x37fc5c8);

typedef double (*t_vexDeviceGpsHeadingGet)(V5_DeviceT device);
inline t_vexDeviceGpsHeadingGet fnVexDeviceGpsHeadingGet =
    (t_vexDeviceGpsHeadingGet)(*(uint32_t *)0x37fc5cc);

typedef double (*t_vexDeviceGpsDegreesGet)(V5_DeviceT device);
inline t_vexDeviceGpsDegreesGet fnVexDeviceGpsDegreesGet =
    (t_vexDeviceGpsDegreesGet)(*(uint32_t *)0x37fc5d0);

typedef void (*t_vexDeviceGpsQuaternionGet)(V5_DeviceT device,
                                            V5_DeviceGpsQuaternion *data);
inline t_vexDeviceGpsQuaternionGet fnVexDeviceGpsQuaternionGet =
    (t_vexDeviceGpsQuaternionGet)(*(uint32_t *)0x37fc5d4);

typedef void (*t_vexDeviceGpsAttitudeGet)(V5_DeviceT device,
                                          V5_DeviceGpsAttitude *data,
                                          bool bRaw);
inline t_vexDeviceGpsAttitudeGet fnVexDeviceGpsAttitudeGet =
    (t_vexDeviceGpsAttitudeGet)(*(uint32_t *)0x37fc5d8);

typedef void (*t_vexDeviceGpsRawGyroGet)(V5_DeviceT device,
                                         V5_DeviceGpsRaw *data);
inline t_vexDeviceGpsRawGyroGet fnVexDeviceGpsRawGyroGet =
    (t_vexDeviceGpsRawGyroGet)(*(uint32_t *)0x37fc5dc);

typedef void (*t_vexDeviceGpsRawAccelGet)(V5_DeviceT device,
                                          V5_DeviceGpsRaw *data);
inline t_vexDeviceGpsRawAccelGet fnVexDeviceGpsRawAccelGet =
    (t_vexDeviceGpsRawAccelGet)(*(uint32_t *)0x37fc5e0);

typedef uint32_t (*t_vexDeviceGpsStatusGet)(V5_DeviceT device);
inline t_vexDeviceGpsStatusGet fnVexDeviceGpsStatusGet =
    (t_vexDeviceGpsStatusGet)(*(uint32_t *)0x37fc5e4);

typedef void (*t_vexDeviceGpsModeSet)(V5_DeviceT device, uint32_t mode);
inline t_vexDeviceGpsModeSet fnVexDeviceGpsModeSet =
    (t_vexDeviceGpsModeSet)(*(uint32_t *)0x37fc5f0);

typedef uint32_t (*t_vexDeviceGpsModeGet)(V5_DeviceT device);
inline t_vexDeviceGpsModeGet fnVexDeviceGpsModeGet =
    (t_vexDeviceGpsModeGet)(*(uint32_t *)0x37fc5f4);

typedef void (*t_vexDeviceGpsDataRateSet)(V5_DeviceT device, uint32_t rate);
inline t_vexDeviceGpsDataRateSet fnVexDeviceGpsDataRateSet =
    (t_vexDeviceGpsDataRateSet)(*(uint32_t *)0x37fc5f8);

typedef void (*t_vexDeviceGpsOriginSet)(V5_DeviceT device, double ox,
                                        double oy);
inline t_vexDeviceGpsOriginSet fnVexDeviceGpsOriginSet =
    (t_vexDeviceGpsOriginSet)(*(uint32_t *)0x37fc5fc);

typedef void (*t_vexDeviceGpsOriginGet)(V5_DeviceT device, double *ox,
                                        double *oy);
inline t_vexDeviceGpsOriginGet fnVexDeviceGpsOriginGet =
    (t_vexDeviceGpsOriginGet)(*(uint32_t *)0x37fc600);

typedef void (*t_vexDeviceGpsRotationSet)(V5_DeviceT device, double value);
inline t_vexDeviceGpsRotationSet fnVexDeviceGpsRotationSet =
    (t_vexDeviceGpsRotationSet)(*(uint32_t *)0x37fc604);

typedef double (*t_vexDeviceGpsRotationGet)(V5_DeviceT device);
inline t_vexDeviceGpsRotationGet fnVexDeviceGpsRotationGet =
    (t_vexDeviceGpsRotationGet)(*(uint32_t *)0x37fc608);

typedef void (*t_vexDeviceGpsInitialPositionSet)(V5_DeviceT device,
                                                 double initial_x,
                                                 double initial_y,
...
inline t_vexDeviceGpsErrorGet fnVexDeviceGpsErrorGet =
    (t_vexDeviceGpsErrorGet)(*(uint32_t *)0x37fc614);

typedef void (*t_vexDeviceAiVisionModeSet)(V5_DeviceT device, uint32_t mode);
inline t_vexDeviceAiVisionModeSet fnVexDeviceAiVisionModeSet =
    (t_vexDeviceAiVisionModeSet)(*(uint32_t *)0x37fcca8);

typedef uint32_t (*t_vexDeviceAiVisionModeGet)(V5_DeviceT device);
inline t_vexDeviceAiVisionModeGet fnVexDeviceAiVisionModeGet =
    (t_vexDeviceAiVisionModeGet)(*(uint32_t *)0x37fccac);
...
typedef int32_t (*t_vexDeviceAiVisionObjectGet)(
    V5_DeviceT device, uint32_t indexObj, V5_DeviceAiVisionObject *pObject);
inline t_vexDeviceAiVisionObjectGet fnVexDeviceAiVisionObjectGet =
    (t_vexDeviceAiVisionObjectGet)(*(uint32_t *)0x37fccb4);

typedef void (*t_vexDeviceAiVisionColorSet)(V5_DeviceT device,
                                            V5_DeviceAiVisionColor *pColor);
inline t_vexDeviceAiVisionColorSet fnVexDeviceAiVisionColorSet =
    (t_vexDeviceAiVisionColorSet)(*(uint32_t *)0x37fccb8);

typedef bool (*t_vexDeviceAiVisionColorGet)(V5_DeviceT device, uint32_t id,
                                            V5_DeviceAiVisionColor *pColor);
inline t_vexDeviceAiVisionColorGet fnVexDeviceAiVisionColorGet =
    (t_vexDeviceAiVisionColorGet)(*(uint32_t *)0x37fccbc);

typedef void (*t_vexDeviceAiVisionCodeSet)(V5_DeviceT device,
                                           V5_DeviceAiVisionCode *pCode);
inline t_vexDeviceAiVisionCodeSet fnVexDeviceAiVisionCodeSet =
    (t_vexDeviceAiVisionCodeSet)(*(uint32_t *)0x37fccc0);

typedef bool (*t_vexDeviceAiVisionCodeGet)(V5_DeviceT device, uint32_t id,
                                           V5_DeviceAiVisionCode *pCode);
inline t_vexDeviceAiVisionCodeGet fnVexDeviceAiVisionCodeGet =
    (t_vexDeviceAiVisionCodeGet)(*(uint32_t *)0x37fccc4);

typedef uint32_t (*t_vexDeviceAiVisionStatusGet)(V5_DeviceT device);
inline t_vexDeviceAiVisionStatusGet fnVexDeviceAiVisionStatusGet =
    (t_vexDeviceAiVisionStatusGet)(*(uint32_t *)0x37fccc8);
...
typedef int32_t (*t_vexDeviceAiVisionClassNameGet)(V5_DeviceT device,
                                                   int32_t id, uint8_t *pName);
inline t_vexDeviceAiVisionClassNameGet fnVexDeviceAiVisionClassNameGet =
    (t_vexDeviceAiVisionClassNameGet)(*(uint32_t *)0x37fccd4);

typedef void (*t_vexDevicePneumaticCompressorSet)(V5_DeviceT device,
                                                  bool bState);
...
typedef void (*t_vexDevicePneumaticCylinderSet)(V5_DeviceT device, uint32_t id,
                                                bool bState);
inline t_vexDevicePneumaticCylinderSet fnVexDevicePneumaticCylinderSet =
    (t_vexDevicePneumaticCylinderSet)(*(uint32_t *)0x37fcc0c);

typedef void (*t_vexDevicePneumaticCtrlSet)(V5_DeviceT device,
                                            V5_DevicePneumaticCtrl *pCtrl);
inline t_vexDevicePneumaticCtrlSet fnVexDevicePneumaticCtrlSet =
    (t_vexDevicePneumaticCtrlSet)(*(uint32_t *)0x37fcc10);

typedef uint32_t (*t_vexDevicePneumaticStatusGet)(V5_DeviceT device);
inline t_vexDevicePneumaticStatusGet fnVexDevicePneumaticStatusGet =
    (t_vexDevicePneumaticStatusGet)(*(uint32_t *)0x37fcc14);

typedef void (*t_vexDevicePneumaticPwmSet)(V5_DeviceT device, uint8_t pwm);
inline t_vexDevicePneumaticPwmSet fnVexDevicePneumaticPwmSet =
    (t_vexDevicePneumaticPwmSet)(*(uint32_t *)0x37fcc18);

typedef uint32_t (*t_vexDevicePneumaticPwmGet)(V5_DeviceT device);
inline t_vexDevicePneumaticPwmGet fnVexDevicePneumaticPwmGet =
    (t_vexDevicePneumaticPwmGet)(*(uint32_t *)0x37fcc1c);

typedef void (*t_vexDevicePneumaticCylinderPwmSet)(V5_DeviceT device,
                                                   uint32_t id, bool bState,
                                                   uint8_t pwm);
...
typedef uint32_t (*t_vexDevicePneumaticActuationStatusGet)(V5_DeviceT device,
                                                           uint16_t *ac1,
                                                           uint16_t *ac2,
                                                           uint16_t *ac3,
                                                           uint16_t *ac4);
inline t_vexDevicePneumaticActuationStatusGet
    fnVexDevicePneumaticActuationStatusGet =
        (t_vexDevicePneumaticActuationStatusGet)(*(uint32_t *)0x37fcc28);

typedef void (*t_vexDisplayForegroundColor)(uint32_t col);
inline t_vexDisplayForegroundColor fnVexDisplayForegroundColor =
    (t_vexDisplayForegroundColor)(*(uint32_t *)0x37fc640);

typedef void (*t_vexDisplayBackgroundColor)(uint32_t col);
inline t_vexDisplayBackgroundColor fnVexDisplayBackgroundColor =
    (t_vexDisplayBackgroundColor)(*(uint32_t *)0x37fc644);
...
inline t_vexDisplayErase fnVexDisplayErase =
    (t_vexDisplayErase)(*(uint32_t *)0x37fc648);

typedef void (*t_vexDisplayScroll)(int32_t nStartLine, int32_t nLines);
inline t_vexDisplayScroll fnVexDisplayScroll =
    (t_vexDisplayScroll)(*(uint32_t *)0x37fc64c);

typedef void (*t_vexDisplayScrollRect)(int32_t x1, int32_t y1, int32_t x2,
                                       int32_t y2, int32_t nLines);
inline t_vexDisplayScrollRect fnVexDisplayScrollRect =
    (t_vexDisplayScrollRect)(*(uint32_t *)0x37fc650);

typedef void (*t_vexDisplayCopyRect)(int32_t x1, int32_t y1, int32_t x2,
                                     int32_t y2, uint32_t *pSrc,
                                     int32_t srcStride);
inline t_vexDisplayCopyRect fnVexDisplayCopyRect =
    (t_vexDisplayCopyRect)(*(uint32_t *)0x37fc654);

typedef void (*t_vexDisplayPixelSet)(uint32_t x, uint32_t y);
inline t_vexDisplayPixelSet fnVexDisplayPixelSet =
    (t_vexDisplayPixelSet)(*(uint32_t *)0x37fc658);

typedef void (*t_vexDisplayPixelClear)(uint32_t x, uint32_t y);
inline t_vexDisplayPixelClear fnVexDisplayPixelClear =
    (t_vexDisplayPixelClear)(*(uint32_t *)0x37fc65c);

typedef void (*t_vexDisplayLineDraw)(int32_t x1, int32_t y1, int32_t x2,
                                     int32_t y2);
inline t_vexDisplayLineDraw fnVexDisplayLineDraw =
    (t_vexDisplayLineDraw)(*(uint32_t *)0x37fc660);

typedef void (*t_vexDisplayLineClear)(int32_t x1, int32_t y1, int32_t x2,
                                      int32_t y2);
inline t_vexDisplayLineClear fnVexDisplayLineClear =
    (t_vexDisplayLineClear)(*(uint32_t *)0x37fc664);

typedef void (*t_vexDisplayRectDraw)(int32_t x1, int32_t y1, int32_t x2,
                                     int32_t y2);
inline t_vexDisplayRectDraw fnVexDisplayRectDraw =
    (t_vexDisplayRectDraw)(*(uint32_t *)0x37fc668);

typedef void (*t_vexDisplayRectClear)(int32_t x1, int32_t y1, int32_t x2,
                                      int32_t y2);
inline t_vexDisplayRectClear fnVexDisplayRectClear =
    (t_vexDisplayRectClear)(*(uint32_t *)0x37fc66c);

typedef void (*t_vexDisplayRectFill)(int32_t x1, int32_t y1, int32_t x2,
                                     int32_t y2);
inline t_vexDisplayRectFill fnVexDisplayRectFill =
    (t_vexDisplayRectFill)(*(uint32_t *)0x37fc670);

typedef void (*t_vexDisplayCircleDraw)(int32_t xc, int32_t yc, int32_t radius);
inline t_vexDisplayCircleDraw fnVexDisplayCircleDraw =
    (t_vexDisplayCircleDraw)(*(uint32_t *)0x37fc674);

typedef void (*t_vexDisplayCircleClear)(int32_t xc, int32_t yc, int32_t radius);
inline t_vexDisplayCircleClear fnVexDisplayCircleClear =
    (t_vexDisplayCircleClear)(*(uint32_t *)0x37fc678);

typedef void (*t_vexDisplayCircleFill)(int32_t xc, int32_t yc, int32_t radius);
inline t_vexDisplayCircleFill fnVexDisplayCircleFill =
    (t_vexDisplayCircleFill)(*(uint32_t *)0x37fc67c);

typedef void (*t_vexDisplayPrintf)(int32_t xpos, int32_t ypos, uint32_t bOpaque,
                                   const char *format, ...);
inline t_vexDisplayPrintf fnVexDisplayPrintf =
    (t_vexDisplayPrintf)(*(uint32_t *)0x37fc680);

typedef void (*t_vexDisplayVPrintf)(int32_t xpos, int32_t ypos,
                                    uint32_t bOpaque, const char *format,
                                    va_list args);
inline t_vexDisplayVPrintf fnVexDisplayVPrintf =
    (t_vexDisplayVPrintf)(*(uint32_t *)0x37fc680);

typedef void (*t_vexDisplayString)(const int32_t nLineNumber,
                                   const char *format, ...);
inline t_vexDisplayString fnVexDisplayString =
    (t_vexDisplayString)(*(uint32_t *)0x37fc684);

typedef void (*t_vexDisplayVString)(const int32_t nLineNumber,
                                    const char *format, va_list args);
inline t_vexDisplayVString fnVexDisplayVString =
    (t_vexDisplayVString)(*(uint32_t *)0x37fc684);

typedef void (*t_vexDisplayStringAt)(int32_t xpos, int32_t ypos,
                                     const char *format, ...);
inline t_vexDisplayStringAt fnVexDisplayStringAt =
    (t_vexDisplayStringAt)(*(uint32_t *)0x37fc688);

typedef void (*t_vexDisplayVStringAt)(int32_t xpos, int32_t ypos,
                                      const char *format, va_list args);
inline t_vexDisplayVStringAt fnVexDisplayVStringAt =
    (t_vexDisplayVStringAt)(*(uint32_t *)0x37fc688);

typedef void (*t_vexDisplayBigString)(const int32_t nLineNumber,
                                      const char *format, ...);
inline t_vexDisplayBigString fnVexDisplayBigString =
    (t_vexDisplayBigString)(*(uint32_t *)0x37fc68c);

typedef void (*t_vexDisplayVBigString)(const int32_t nLineNumber,
                                       const char *format, va_list args);
inline t_vexDisplayVBigString fnVexDisplayVBigString =
    (t_vexDisplayVBigString)(*(uint32_t *)0x37fc68c);

typedef void (*t_vexDisplayBigStringAt)(int32_t xpos, int32_t ypos,
                                        const char *format, ...);
inline t_vexDisplayBigStringAt fnVexDisplayBigStringAt =
    (t_vexDisplayBigStringAt)(*(uint32_t *)0x37fc690);

typedef void (*t_vexDisplayVBigStringAt)(int32_t xpos, int32_t ypos,
                                         const char *format, va_list args);
inline t_vexDisplayVBigStringAt fnVexDisplayVBigStringAt =
    (t_vexDisplayVBigStringAt)(*(uint32_t *)0x37fc690);

typedef void (*t_vexDisplaySmallStringAt)(int32_t xpos, int32_t ypos,
                                          const char *format, ...);
inline t_vexDisplaySmallStringAt fnVexDisplaySmallStringAt =
    (t_vexDisplaySmallStringAt)(*(uint32_t *)0x37fc6b0);

typedef void (*t_vexDisplayVSmallStringAt)(int32_t xpos, int32_t ypos,
                                           const char *format, va_list args);
inline t_vexDisplayVSmallStringAt fnVexDisplayVSmallStringAt =
    (t_vexDisplayVSmallStringAt)(*(uint32_t *)0x37fc6b0);

typedef void (*t_vexDisplayCenteredString)(const int32_t nLineNumber,
                                           const char *format, ...);
inline t_vexDisplayCenteredString fnVexDisplayCenteredString =
    (t_vexDisplayCenteredString)(*(uint32_t *)0x37fc694);

typedef void (*t_vexDisplayVCenteredString)(const int32_t nLineNumber,
                                            const char *format, va_list args);
inline t_vexDisplayVCenteredString fnVexDisplayVCenteredString =
    (t_vexDisplayVCenteredString)(*(uint32_t *)0x37fc694);

typedef void (*t_vexDisplayBigCenteredString)(const int32_t nLineNumber,
                                              const char *format, ...);
inline t_vexDisplayBigCenteredString fnVexDisplayBigCenteredString =
    (t_vexDisplayBigCenteredString)(*(uint32_t *)0x37fc698);

typedef void (*t_vexDisplayVBigCenteredString)(const int32_t nLineNumber,
                                               const char *format,
                                               va_list args);
...
inline t_vexDisplayTextSize fnVexDisplayTextSize =
    (t_vexDisplayTextSize)(*(uint32_t *)0x37fc6a8);

typedef void (*t_vexDisplayFontNamedSet)(const char *pFontName);
inline t_vexDisplayFontNamedSet fnVexDisplayFontNamedSet =
    (t_vexDisplayFontNamedSet)(*(uint32_t *)0x37fc6b4);

typedef int32_t (*t_vexDisplayStringWidthGet)(const char *pString);
inline t_vexDisplayStringWidthGet fnVexDisplayStringWidthGet =
    (t_vexDisplayStringWidthGet)(*(uint32_t *)0x37fc6c0);

typedef int32_t (*t_vexDisplayStringHeightGet)(const char *pString);
inline t_vexDisplayStringHeightGet fnVexDisplayStringHeightGet =
    (t_vexDisplayStringHeightGet)(*(uint32_t *)0x37fc6c4);

typedef FRESULT (*t_vexFileMountSD)(void);
inline t_vexFileMountSD fnVexFileMountSD =
    (t_vexFileMountSD)(*(uint32_t *)0x37fc7d0);

typedef FRESULT (*t_vexFileDirectoryGet)(const char *path, char *buffer,
                                         uint32_t len);
inline t_vexFileDirectoryGet fnVexFileDirectoryGet =
    (t_vexFileDirectoryGet)(*(uint32_t *)0x37fc7d4);
...
inline t_vexFileOpenWrite fnVexFileOpenWrite =
    (t_vexFileOpenWrite)(*(uint32_t *)0x37fc7dc);

typedef FIL *(*t_vexFileOpenCreate)(const char *filename);
inline t_vexFileOpenCreate fnVexFileOpenCreate =
    (t_vexFileOpenCreate)(*(uint32_t *)0x37fc7e0);

typedef void (*t_vexFileClose)(FIL *fdp);
inline t_vexFileClose fnVexFileClose = (t_vexFileClose)(*(uint32_t *)0x37fc7e4);

typedef int32_t (*t_vexFileRead)(char *buf, uint32_t size, uint32_t nItems,
                                 FIL *fdp);
inline t_vexFileRead fnVexFileRead = (t_vexFileRead)(*(uint32_t *)0x37fc7f8);

typedef int32_t (*t_vexFileWrite)(char *buf, uint32_t size, uint32_t nItems,
                                  FIL *fdp);
...
inline t_vexFileDriveStatus fnVexFileDriveStatus =
    (t_vexFileDriveStatus)(*(uint32_t *)0x37fc7fc);
...
inline t_vexFileStatus fnVexFileStatus =
    (t_vexFileStatus)(*(uint32_t *)0x37fc808);

typedef int32_t (*t_vexSerialWriteChar)(uint32_t channel, uint8_t c);
inline t_vexSerialWriteChar fnVexSerialWriteChar =
    (t_vexSerialWriteChar)(*(uint32_t *)0x37fc898);

typedef int32_t (*t_vexSerialWriteBuffer)(uint32_t channel, uint8_t *data,
                                          uint32_t data_len);
inline t_vexSerialWriteBuffer fnVexSerialWriteBuffer =
    (t_vexSerialWriteBuffer)(*(uint32_t *)0x37fc89c);

typedef int32_t (*t_vexSerialReadChar)(uint32_t channel);
inline t_vexSerialReadChar fnVexSerialReadChar =
    (t_vexSerialReadChar)(*(uint32_t *)0x37fc8a0);

typedef int32_t (*t_vexSerialPeekChar)(uint32_t channel);
inline t_vexSerialPeekChar fnVexSerialPeekChar =
    (t_vexSerialPeekChar)(*(uint32_t *)0x37fc8a4);

typedef int32_t (*t_vexSerialWriteFree)(uint32_t channel);
inline t_vexSerialWriteFree fnVexSerialWriteFree =
    (t_vexSerialWriteFree)(*(uint32_t *)0x37fc8ac);

typedef void (*t_vexSystemTimerStop)(void);
inline t_vexSystemTimerStop fnVexSystemTimerStop =
    (t_vexSystemTimerStop)(*(uint32_t *)0x37fc8c0);
...
typedef int32_t (*t_vexSystemTimerReinitForRtos)(uint32_t priority,
                                                 void (*handler)(void *data));
inline t_vexSystemTimerReinitForRtos fnVexSystemTimerReinitForRtos =
    (t_vexSystemTimerReinitForRtos)(*(uint32_t *)0x37fc8c8);
...
inline t_vexSystemWatchdogReinitRtos fnVexSystemWatchdogReinitRtos =
    (t_vexSystemWatchdogReinitRtos)(*(uint32_t *)0x37fc8d0);

typedef uint32_t (*t_vexSystemWatchdogGet)(void);
inline t_vexSystemWatchdogGet fnVexSystemWatchdogGet =
    (t_vexSystemWatchdogGet)(*(uint32_t *)0x37fc8d4);

typedef void (*t_vexSystemBoot)(void);
inline t_vexSystemBoot fnVexSystemBoot =
    (t_vexSystemBoot)(*(uint32_t *)0x37fc910);

typedef void (*t_vexSystemUndefinedException)(void);
inline t_vexSystemUndefinedException fnVexSystemUndefinedException =
    (t_vexSystemUndefinedException)(*(uint32_t *)0x37fc914);

typedef void (*t_vexSystemFIQInterrupt)(void);
inline t_vexSystemFIQInterrupt fnVexSystemFIQInterrupt =
    (t_vexSystemFIQInterrupt)(*(uint32_t *)0x37fc918);

typedef void (*t_vexSystemSWInterrupt)(void);
inline t_vexSystemSWInterrupt fnVexSystemSWInterrupt =
    (t_vexSystemSWInterrupt)(*(uint32_t *)0x37fc920);

typedef void (*t_vexSystemDataAbortInterrupt)(void);
inline t_vexSystemDataAbortInterrupt fnVexSystemDataAbortInterrupt =
    (t_vexSystemDataAbortInterrupt)(*(uint32_t *)0x37fc924);
...
typedef void (*t_vexTouchUserCallbackSet)(void (*callback)(V5_TouchEvent,
                                                           int32_t, int32_t));
inline t_vexTouchUserCallbackSet fnVexTouchUserCallbackSet =
    (t_vexTouchUserCallbackSet)(*(uint32_t *)0x37fc960);

typedef bool (*t_vexTouchDataGet)(V5_TouchStatus *status);
inline t_vexTouchDataGet fnVexTouchDataGet =
    (t_vexTouchDataGet)(*(uint32_t *)0x37fc964);

typedef uint32_t (*t_vexImageBmpRead)(const uint8_t *ibuf, v5_image *oBuf,
                                      uint32_t maxw, uint32_t maxh);
inline t_vexImageBmpRead fnVexImageBmpRead =
    (t_vexImageBmpRead)(*(uint32_t *)0x37fc990);

typedef uint32_t (*t_vexImagePngRead)(const uint8_t *ibuf, v5_image *oBuf,
                                      uint32_t maxw, uint32_t maxh,
                                      uint32_t ibuflen);
inline t_vexImagePngRead fnVexImagePngRead =
    (t_vexImagePngRead)(*(uint32_t *)0x37fc994);

typedef void (*t_vexDisplayClipRegionSet)(int32_t x1, int32_t y1, int32_t x2,
                                          int32_t y2);
inline t_vexDisplayClipRegionSet fnVexDisplayClipRegionSet =
    (t_vexDisplayClipRegionSet)(*(uint32_t *)0x37fc794);

typedef bool (*t_vexDisplayRender)(bool bVsyncWait, bool bRunScheduler);
inline t_vexDisplayRender fnVexDisplayRender =
    (t_vexDisplayRender)(*(uint32_t *)0x37fc7a0);
...
inline t_vexCompetitionStatus fnVexCompetitionStatus =
    (t_vexCompetitionStatus)(*(uint32_t *)0x37fc9d8);

typedef void (*t_vexCompetitionControl)(uint32_t data);
inline t_vexCompetitionControl fnVexCompetitionControl =
    (t_vexCompetitionControl)(*(uint32_t *)0x37fc9dc);

typedef int32_t (*t_vexBatteryVoltageGet)(void);
inline t_vexBatteryVoltageGet fnVexBatteryVoltageGet =
    (t_vexBatteryVoltageGet)(*(uint32_t *)0x37fca00);

typedef int32_t (*t_vexBatteryCurrentGet)(void);
inline t_vexBatteryCurrentGet fnVexBatteryCurrentGet =
    (t_vexBatteryCurrentGet)(*(uint32_t *)0x37fca04);

typedef double (*t_vexBatteryTemperatureGet)(void);
inline t_vexBatteryTemperatureGet fnVexBatteryTemperatureGet =
    (t_vexBatteryTemperatureGet)(*(uint32_t *)0x37fca08);

typedef double (*t_vexBatteryCapacityGet)(void);
inline t_vexBatteryCapacityGet fnVexBatteryCapacityGet =
    (t_vexBatteryCapacityGet)(*(uint32_t *)0x37fca0c);

typedef void (*t_vexDeviceGenericSerialEnable)(V5_DeviceT device,
                                               int32_t options);
inline t_vexDeviceGenericSerialEnable fnVexDeviceGenericSerialEnable =
    (t_vexDeviceGenericSerialEnable)(*(uint32_t *)0x37fca50);

typedef void (*t_vexDeviceGenericSerialBaudrate)(V5_DeviceT device,
                                                 int32_t baudrate);
...
typedef int32_t (*t_vexDeviceGenericSerialWriteChar)(V5_DeviceT device,
                                                     uint8_t c);
...
typedef int32_t (*t_vexDeviceGenericSerialTransmit)(V5_DeviceT device,
                                                    uint8_t *buffer,
                                                    int32_t length);
...
inline t_vexDeviceGenericSerialReceiveAvail
    fnVexDeviceGenericSerialReceiveAvail =
        (t_vexDeviceGenericSerialReceiveAvail)(*(uint32_t *)0x37fca6c);

typedef int32_t (*t_vexDeviceGenericSerialReceive)(V5_DeviceT device,
                                                   uint8_t *buffer,
                                                   int32_t length);
...
inline t_vexDeviceGenericSerialFlush fnVexDeviceGenericSerialFlush =
    (t_vexDeviceGenericSerialFlush)(*(uint32_t *)0x37fca74);

typedef void (*t_vexDeviceGenericRadioConnection)(V5_DeviceT device,
                                                  char *pName, bool bMaster,
                                                  bool bAllowRadioOverride);
...
typedef int32_t (*t_vexDeviceGenericRadioWriteChar)(V5_DeviceT device,
                                                    uint8_t c);
...
typedef int32_t (*t_vexDeviceGenericRadioTransmit)(V5_DeviceT device,
                                                   uint8_t *buffer,
                                                   int32_t length);
...
typedef int32_t (*t_vexDeviceGenericRadioReceive)(V5_DeviceT device,
                                                  uint8_t *buffer,
                                                  int32_t length);
...
inline t_vexDeviceGenericRadioFlush fnVexDeviceGenericRadioFlush =
    (t_vexDeviceGenericRadioFlush)(*(uint32_t *)0x37fcac4);
